...
public class AlgorithmResults {
    ...
    public AlgorithmResults(Problem problem, List<Integer> bestIndividualInGen, Double averageFitnessInGen, List<Integer> bestIndividual, Integer actualGeneration) {
